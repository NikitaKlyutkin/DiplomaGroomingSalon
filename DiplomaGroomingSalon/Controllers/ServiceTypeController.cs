...
public class ServiceTypeController : Controller
{
	...
	public ServiceTypeController(ICRUDDataService<PetType> petTypeService,
		ICRUDDataService<ServiceType> serviceTypeService)
	{
	...
	public async Task<IActionResult> DeleteServiceTypes(Guid id)
	{
		...
		if (response.StatusCode == Domain.Enum.StatusCode.OK) return RedirectToAction("GetServiceTypes");
		return View(response.Description);
	}
}